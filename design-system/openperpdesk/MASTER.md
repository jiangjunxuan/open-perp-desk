...
**Project:** OpenPerpDesk
**Generated:** 2026-09-13 04:16:21
...
| Background | `#070A0F` | `--color-background` |
| Foreground | `#F4F7F5` | `--color-foreground` |
| Card | `#0D131B` | `--color-card` |
| Card Foreground | `#F4F7F5` | `--color-card-foreground` |
| Muted | `#1A1E2F` | `--color-muted` |
| Muted Foreground | `#94A3B8` | `--color-muted-foreground` |
| Border | `#273442` | `--color-border` |
