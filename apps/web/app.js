...
const executionReasons = {
  ...
  close_position_changed: "持仓成交已变化，本次平仓未提交，请重新核对",
  close_protection_unverified: "当前保护依据未核实，本次平仓未提交",
  close_protection_changed: "交易所保护参数已变化或失效，本次平仓未提交",
  pending_close_order_unconfirmed: "已有平仓订单待确认，请先完成对账",
